...
public slots:
  ...
  void on_stlChooser1_released();

  void on_stlChooser2_released();

  void on_stlColorPicker1_clicked();

  void on_stlColorPicker2_clicked();

  void onstlColorPicker1_received();

  void onstlColorPicker2_received();

  void on_grdTexSizeBox_valueChanged(double arg1);
