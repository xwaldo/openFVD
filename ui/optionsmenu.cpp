...
optionsMenu::optionsMenu(QWidget *parent)
    : QDialog(parent), ui(new Ui::optionsMenu) {
  ...
  if (!QFileInfo(QString(optionsFile)).exists() || !loadFromOptionsFile()) {
    ...
    shadowQuality = 1;
    fov = 90.0;
    rollColor[0] = QColor(160, 0, 0, 255);
    rollColor[1] = QColor(160, 0, 0, 25);
    rollColor[2] = QColor(255, 0, 0, 255);
    rollColor[3] = QColor(255, 0, 0, 25);
    normColor[0] = QColor(0, 0, 160, 255);
    normColor[1] = QColor(0, 0, 160, 25);
    normColor[2] = QColor(0, 0, 255, 255);
    normColor[3] = QColor(0, 0, 255, 25);
    latColor[0] = QColor(0, 160, 0, 255);
    latColor[1] = QColor(0, 160, 0, 25);
    latColor[2] = QColor(0, 255, 0, 255);
    latColor[3] = QColor(0, 255, 0, 25);
    pitchColor[0] = QColor(0, 160, 160, 255);
    pitchColor[1] = QColor(0, 160, 160, 25);
    pitchColor[2] = QColor(0, 255, 255, 255);
    pitchColor[3] = QColor(0, 255, 255, 25);
    yawColor[0] = QColor(160, 160, 0, 255);
    yawColor[1] = QColor(160, 160, 0, 25);
...
void optionsMenu::saveToOptionsFile() // Ercan: Config file Erstellung hier
{
  ...
  fout << "backgroundColor " << backgroundColor.red() << " "
       << backgroundColor.green() << " " << backgroundColor.blue() << "\n";
  fout << "glPolicy " << glPolicy << "\n";
  fout << "fov " << fov << "\n";
  fout << "shadowQuality " << shadowQuality << "\n";
  fout << "meshQuality " << meshQuality << "\n";
  fout << "nSelRollLine " << rollColor[0].red() << " " << rollColor[0].green()
       << " " << rollColor[0].blue() << " " << rollColor[0].alpha() << "\n";
  fout << "nSelRollBack " << rollColor[1].red() << " " << rollColor[1].green()
       << " " << rollColor[1].blue() << " " << rollColor[1].alpha() << "\n";
  fout << "selRollLine " << rollColor[2].red() << " " << rollColor[2].green()
       << " " << rollColor[2].blue() << " " << rollColor[2].alpha() << "\n";
  fout << "selRollBack " << rollColor[3].red() << " " << rollColor[3].green()
       << " " << rollColor[3].blue() << " " << rollColor[3].alpha() << "\n";

  fout << "nSelNormLine " << normColor[0].red() << " " << normColor[0].green()
       << " " << normColor[0].blue() << " " << normColor[0].alpha() << "\n";
  fout << "nSelNormBack " << normColor[1].red() << " " << normColor[1].green()
       << " " << normColor[1].blue() << " " << normColor[1].alpha() << "\n";
  fout << "selNormLine " << normColor[2].red() << " " << normColor[2].green()
       << " " << normColor[2].blue() << " " << normColor[2].alpha() << "\n";
  fout << "selNormBack " << normColor[3].red() << " " << normColor[3].green()
       << " " << normColor[3].blue() << " " << normColor[3].alpha() << "\n";

  fout << "nSelLatLine " << latColor[0].red() << " " << latColor[0].green()
       << " " << latColor[0].blue() << " " << latColor[0].alpha() << "\n";
  fout << "nSelLatBack " << latColor[1].red() << " " << latColor[1].green()
       << " " << latColor[1].blue() << " " << latColor[1].alpha() << "\n";
  fout << "selLatLine " << latColor[2].red() << " " << latColor[2].green()
       << " " << latColor[2].blue() << " " << latColor[2].alpha() << "\n";
  fout << "selLatBack " << latColor[3].red() << " " << latColor[3].green()
       << " " << latColor[3].blue() << " " << latColor[3].alpha() << "\n";

  fout << "nSelPitchLine " << pitchColor[0].red() << " "
       << pitchColor[0].green() << " " << pitchColor[0].blue() << " "
       << pitchColor[0].alpha() << "\n";
  fout << "nSelPitchBack " << pitchColor[1].red() << " "
       << pitchColor[1].green() << " " << pitchColor[1].blue() << " "
       << pitchColor[1].alpha() << "\n";
  fout << "selPitchLine " << pitchColor[2].red() << " " << pitchColor[2].green()
       << " " << pitchColor[2].blue() << " " << pitchColor[2].alpha() << "\n";
  fout << "selPitchBack " << pitchColor[3].red() << " " << pitchColor[3].green()
       << " " << pitchColor[3].blue() << " " << pitchColor[3].alpha() << "\n";

  fout << "nSelYawLine " << yawColor[0].red() << " " << yawColor[0].green()
       << " " << yawColor[0].blue() << " " << yawColor[0].alpha() << "\n";
  fout << "nSelYawBack " << yawColor[1].red() << " " << yawColor[1].green()
       << " " << yawColor[1].blue() << " " << yawColor[1].alpha() << "\n";
  fout << "selYawLine " << yawColor[2].red() << " " << yawColor[2].green()
       << " " << yawColor[2].blue() << " " << yawColor[2].alpha() << "\n";
  fout << "selYawBack " << yawColor[3].red() << " " << yawColor[3].green()
       << " " << yawColor[3].blue() << " " << yawColor[3].alpha() << "\n";
...
void optionsMenu::on_glBox_currentIndexChanged(int index) { glPolicy = index; }

void optionsMenu::setGLVersionString(QString version) {
  this->ui->glInfoLabel->setText(
      QString("Detected OpenGL driver: ").append(version));
}
...
void optionsMenu::on_gridBox_stateChanged(int arg1) { drawGrid = arg1; }
