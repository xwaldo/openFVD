...
QCPGrid::QCPGrid(QCPAxis *parentAxis)
  ...
  setSubGridPen(QPen(QColor(250, 250, 250), 0, Qt::DotLine));
...
*/
void QCPAxis::scaleRange(double factor, double center, float xLowerBoundary,
                         float xUpperBoundary) {
  QCPRange oldRange = mRange;
  if (mScaleType == stLinear) {
    QCPRange newRange;
    newRange.lower = (mRange.lower - center) * factor + center;
    if (newRange.lower < xLowerBoundary)
      newRange.lower = xLowerBoundary;
    newRange.upper = (mRange.upper - center) * factor + center;
    if (newRange.upper > xUpperBoundary)
      newRange.upper = xUpperBoundary;
      ...
      if (mRangeZoom.testFlag(Qt::Horizontal)) {
        ...
        if (mRangeZoomHorzAxis.data())
          mRangeZoomHorzAxis.data()->scaleRange(
              ...
              xLowerBoundary, xUpperBoundary); // Lenny
      }
