...
class graphHandler {
public:
  graphHandler(QTreeWidgetItem *_treeItem, enum graphType _type,
               trackHandler *_track, QCPAxis *_axis, QColor *_color);

  void fillGraphList(QCPAxis *xAxis, bool _argument = TIME,
                     bool _orientation = QUATERNION, bool _drawExterns = true);
