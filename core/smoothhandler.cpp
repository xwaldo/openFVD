...
int smoothHandler::getFrom() { return fromNode; }

int smoothHandler::getTo() { return toNode; }

int smoothHandler::getLength() { return length; }

int smoothHandler::getIterations() { return iterations; }
